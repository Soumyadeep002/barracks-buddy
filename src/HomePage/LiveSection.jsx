    ...
    <section className='py-16 px-5'>
        <div className="bg-gray-300 md:w-[90%] lg:w-[70%] overflow-hidden gap-5 flex flex-col-reverse md:flex-row items-center mx-auto rounded-[2.5rem]">
            ...
            <div className="w-full md:w-3/5 px-3 flex flex-col justify-center item-center gap-5 py-10">
                <div className='bg-yellow-300 px-6 py-2 text-center flex justify-center items-center gap-3  mx-auto rounded-[9rem]'>
                    <div className='font-bold text-sm md:text-xl'>Written Training Program </div><img class className='w-5 md:w-3 lg:w-5' src={Play} alt=""/>
                </div>
