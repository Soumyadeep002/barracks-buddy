...
export default function AuthOtp() {
  ...
  return (
    ...
    <p className="  pb-4 italic  font-bold text-[#3b692f]">
        *THE OTP HAS BEEN SEND TO YOUR EMAIL
    </p>
    ...
    <div className="container flex flex-col items-center">
      ...
      <p className=" mt-2  cursor-pointer ctext-start text-sm font-semibold text-body-color">
            Resend Code
          </p>
      <div className="mt-6 sm:mt-8">
        <button className="bg-[#2f5325] rounded-full py-3 px-6 flex items-center justify-center transition-colors duration-300 hover:bg-opacity-90 mx-auto">
