...
export default function NotesPage() {
  return (
    ...
    <div className='w-full md:w-[90%] lg:w-[70%] mx-auto'>
        ...
        <div className=" bg-gray-300 rounded-[2.5rem] p-7 md:p-8 lg:p-10 mx-auto flex flex-col gap-10">
                <div className="bg-white rounded-[2rem] px-6 md:px-7 lg:px-8 py-10 flex flex-col gap-3 md:gap-6 lg:gap-12">
